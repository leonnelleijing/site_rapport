...
/* 
Ce fichier permet d'afficher les sections HHTML rÈcurrentes 
 */
		...
		<nav class="navbar navbar-expand-lg navbar-light">
	  		...
	  		<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mx-4" href="deconnection.php">DÈconnexion <span class="oi oi-power-standby"></span></a>
                                </li>
                            </ul>
			</div>
		</nav>	
...
?>      <div class="col-md-2 bg-dark" id="sidebar">
		        ...
		        <a href="admin.php" class="active"><span class="oi oi-dashboard"></span>Table de bord</a><span class="badge badge-danger mx-1">4</span>
                    ...
                    <li role="presentation">
                        <a href="#" data-toggle="collapse" data-target="#list3"><span class="oi oi-cog"></span>Param√®tre</a>
